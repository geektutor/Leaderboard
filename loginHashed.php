...
<?php
    ...
    <img class="devImg" src="https://img.icons8.com/officel/80/000000/code.png">
        ...
        <?php }?>
        <div class="group">
            <input type="email" value="<?php if(isset($_POST['email'])) echo htmlspecialchars($_POST['email'], ENT_QUOTES)?>"name="email" placeholder="Email" required><i class="fa fa-user"></i>
        </div>
        <div class="group">
        ...
        <?php //please change this link too ?>
        <p >Don't have an account ? <a href="signupHashed.php">Signup</a></p>
    </form>
