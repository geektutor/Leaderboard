  ...
  <button id="submitTask" type="submit" name="submit" value="submit">Receive Certificate</button>          
        ...
        <?php  
            if (isset($_POST['submit'])){
              $certify = 0;
              $sentence = "http://try30daysofcode.pythonanywhere.com/mentor/?first_name={$first}&last_name={$last}&track={$track}&level={$level}";
...
<script type="text/javascript">
  function check(event) {
      ...
      $.ajax({
          url: 'http://try30daysofcode.pythonanywhere.com/mentor/',
